      ...
      >
        <View style={styles.container}>
          ...
          {rewardDetails?.status_code === undefined ? (
            <View style={styles.boxContainer}>
              <View style={{ paddingHorizontal: 20, paddingVertical: 10 }}>
                <Text style={TextTheme.titleSmall}>
                  Points Available: {rewardPoints}
                </Text>
              </View>
              <Divider />
              {rewardDetails?.customerRewardList.length <= 0 ? (
                <Text
                  style={[
                    styles.notFound,
                ...
                >
                  There are no Reward points for this customer
                </Text>
              ) : (
                <FlatList
                  scrollEnabled={false}
                          ...
                          <Text
                            style={[
                              item.transaction_type === "Earned"
                                ? styles.transactionTypeEarned
                                : styles.transactionTypeRedeemed,
                              TextTheme.bodySmall,
                            ]}
                          >
            ...
            <Text style={[styles.notFound, TextTheme.titleSmall]}>
              No Data Found
            </Text>
          )}
        </View>
