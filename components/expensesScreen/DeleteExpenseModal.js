...
import {loadExpensesFromDb} from "../../store/ExpensesSlice";
import deleteExpenseAPI from "../../util/apis/deleteExpenseAPI";
        ...
        >
            ...
            >
                ...
                <View style={styles.deleteClientCardContainer}>
                    <Text style={[textTheme.titleMedium]}>{props.content}</Text>
